...
class StarWarsVideo extends StatefulWidget {
  @override
  _StarWarsVideoState createState() => _StarWarsVideoState();
}

class _StarWarsVideoState extends State<StarWarsVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/video/starWarsVideo.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
