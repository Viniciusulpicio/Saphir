...
class LegoCity extends StatefulWidget {
  const LegoCity({super.key});

  @override
  State<LegoCity> createState() => _LegoCityState();
}

class _LegoCityState extends State<LegoCity> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      child: Image.asset(
                        'assets/image/jogos/legoCity.png',
                      ),
                    ),
                    ...
                    const SizedBox(height: 10),
                        ...
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: ' Siga o policial Chase McCain em uma missão de mundo aberto para capturar o infame criminoso Rex Fury, enquanto explora a cidade de LEGO® City repleta de ação e humor.', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
