...
class BloonsTd extends StatefulWidget {
  const BloonsTd({super.key});

  @override
  State<BloonsTd> createState() => _BloonsTdState();
}

class _BloonsTdState extends State<BloonsTd> {
                      ...
                      Text.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: '14/Jun/2018', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
                      ...
                      child: Text.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: 'Ninja Kiwi', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
                    ...
                    const SizedBox(height: 10),
                        ...
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: 'Enfrente ondas de balões coloridos com uma variedade de torres e habilidades em um emocionante jogo de estratégia. Melhore suas defesas e colha recompensas enquanto avança em mapas desafiadores.', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
