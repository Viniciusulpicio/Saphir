...
class SilentHill extends StatefulWidget {
  const SilentHill({super.key});

  @override
  State<SilentHill> createState() => _SilentHillState();
}

class _SilentHillState extends State<SilentHill> {
                      ...
                      child: Text.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: 'Konami', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
                    ...
                    const SizedBox(height: 10),
                        ...
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: 'James Sunderland chegou na cidade de Silent Hill, Maine, depois de receber uma carta de sua esposa Mary, apesar do fato de que ela morreu de uma doença crônica três anos antes. A carta afirma que Mary está esperando por James em seu "lugar especial', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
