...
class RedDead extends StatefulWidget {
  const RedDead({super.key});

  @override
  State<RedDead> createState() => _RedDeadState();
}

class _RedDeadState extends State<RedDead> {
                      ...
                      Text.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: '26/Out/2018', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
                    ...
                    const SizedBox(height: 10),
                        ...
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: 'Embarque em uma jornada épica no Velho Oeste com Arthur Morgan e a gangue Van der Linde, enquanto tentam sobreviver em um mundo implacável cheio de conflitos, roubos e dramas pessoais, com um realismo impressionante e uma narrativa envolvente..', // Parte que ficará normal
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
